...
export default class PeopleProfile extends Component {
  ...
  username = this.props.route.params.item.title;
  render() {
          ...
          {userData.map((item, index) => {
            return (
              <View key={index}>
                ...
                <View>
                  <Text style={styles.textValue}>{this.Name}</Text>
                  <Text style={styles.texts}>{item.title}</Text>
                  <Text style={styles.texts}>{item.desc}</Text>
                  <Text style={styles.texts}>{item.website}</Text>
                </View>
              </View>
            );
          })}
          ...
          <RBSheet
            ...
            <View>
              ...
              <View style={styles.actionTextContainer}>
                ...
                <Text style={styles.actionText}>Hide Your Story</Text>
                <Text style={styles.actionText}>Remove Follower</Text>
                <Text style={styles.actionText}>Copy Profile URL</Text>
          ...
          <RBSheet
            ...
            <View>
              ...
              <View style={styles.actionTextContainer}>
                ...
                <Text style={styles.actionText}>Live Videos</Text>
                <Text style={styles.actionText}>Copy Profile URL</Text>
                <Text style={styles.actionText}>Share this Profile</Text>
              </View>
            </View>
